...
import {
  BoxSelect, ChevronDown, CircleDot, Download, FilePlus, FlipHorizontal, FlipVertical,
    ...
    <div className="uv-workspace h-full flex flex-col select-none overflow-hidden">
      ...
      <div className="uv-toolbar shrink-0">
        ...
        <div className="uv-seg" title="Mesh texture image">
          ...
          <div className="w-px h-3.5 bg-[var(--ts-border)] mx-0.5" />
        ...
        {showProperties && (
          <aside className="uv-inspector shrink-0 flex flex-col min-h-0">
            ...
            <div className="grid grid-cols-3 gap-1 px-2 pb-2">
              <button
                type="button"
                className="uv-btn flex items-center justify-center gap-1 py-1"
                onClick={() => {
                  setNewImageSize(textureCanvas ? Math.max(textureCanvas.width, textureCanvas.height) : 256);
                  setNewImageCustomSize('');
                  setNewImageBg('transparent');
      ...
      {newImageModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 select-none" onClick={() => setNewImageModalOpen(false)}>
      ...
      {saveAsModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 select-none" onClick={() => setSaveAsModalOpen(false)}>
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#858a93]">
                  Export current texture ({textureResolution.width}×{textureResolution.height}) as PNG
                </p>
              </div>
            </div>
