  ...
  const sections: ShortcutSection[] = [
    {
      title: 'Viewport',
      rows: [
        { key: 'Ctrl + S', action: 'Save project (.polystage)' },
    ...
    },
    {
      ...
      rows: [
        ...
        { key: '.', action: 'Pivot tool — move origin, mesh stays' },
        { key: 'E / I', action: 'Extrude (mode-locked) / Inset face' },
        { key: 'Ctrl + B', action: 'Bevel (edges · selected faces · vertex corner)' },
        { key: 'Ctrl + R', action: 'Loop cut (hover edge · wheel adds cuts)' },
        { key: 'K', action: 'Knife cut (click a path · Enter confirms)' },
        { key: 'F', action: 'Fill (verts → face · edges → loop · faces → close holes)' },
        { key: 'Ctrl + M', action: 'Mirror selected geometry across the active axis' },
        { key: 'Alt + X', action: 'Mirror whole mesh (symmetry)' },
        { key: 'M', action: 'Merge selected vertices by distance' },
        { key: 'Ctrl + Shift + D', action: 'Add Subdivision modifier' },
        { key: 'Shift + D', action: 'Duplicate selection' },
        { key: 'P', action: 'Separate selection into new object' },
        { key: 'Delete', action: 'Delete selection' },
        { key: 'LMB / 1-finger', action: 'Orbit (pan in Front/Top/Side)' },
        { key: 'RMB / Space-drag / 2-finger', action: 'Pan view' },
        { key: 'Wheel / pinch', action: 'Zoom' },
        { key: 'Stylus tip', action: 'Same as LMB · reverse tip erases in paint' },
    ...
    },
    {
      ...
      rows: [
        ...
        { key: 'Shift / Ctrl + Click', action: 'Toggle in selection' },
        { key: 'Alt + Click', action: 'Remove from selection' },
        { key: 'Ctrl + Drag', action: 'Box select · Shift adds' },
    ...
    },
    {
      ...
      rows: [
        ...
        { key: 'Stylus', action: 'Draw with pressure · reverse tip erases' },
        { key: 'Ctrl + Z / Y', action: 'Undo / Redo' },
    ...
    },
    {
      ...
      rows: [
        ...
        { key: 'LMB / stylus on mesh', action: 'Paint (pressure scales brush)' },
        { key: 'Pen eraser / E', action: 'Erase' },
        { key: 'Alt+LMB / empty drag', action: 'Orbit while paint is armed' },
        { key: 'RMB / Space-drag', action: 'Pan' },
      ],
    },
    {
      title: 'Animation',
